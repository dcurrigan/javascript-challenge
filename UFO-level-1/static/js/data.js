...
<meta content="02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js · master · The University of Western Australia / WAUS-PERTH-VIRT-DATA-PT-03-2021-U-C" property="og:title">
...
<meta content="https://waustralia.bootcampcontent.com/the-university-of-western-australia/waus-perth-virt-data-pt-03-2021-u-c/-/blob/master/02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js · master · The University of Western Australia / WAUS-PERTH-VIRT-DATA-PT-03-2021-U-C" property="twitter:title">
...
<title>02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js · master · The University of Western Australia / WAUS-PERTH-VIRT-DATA-PT-03-2021-U-C · GitLab</title>
...
<meta name="csrf-token" content="cnmsCvYPCzchCo6Z4ANEPR3laFtMxnsiA3xnpU8LosTlWU3Owuv1THv5+lXN0Xb3JGkvVgreAw0GBWGGAxIJ7w==" />
<meta name="csp-nonce" />
...
<a href="/the-university-of-western-australia/waus-perth-virt-data-pt-03-2021-u-c/-/blob/master/02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js">Repository</a>
</h2>
</li>
</ul>
</div>
...
<input type="hidden" name="path" id="path" value="02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/the-university-of-western-australia/waus-perth-virt-data-pt-03-2021-u-c/-/blob/master/02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js"><strong>data.js</strong>
</a></li>
</ul>
</div>
...
<button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy file contents" data-clipboard-target=".blob-content[data-blob-id=&#39;bf9d49ee037e240c89002d40005a32fa4bd05065&#39;] &gt; pre" type="button" title="Copy file contents" aria-label="Copy file contents"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-15cbe21ccc2237b075efb0b0d170fc8d6716882dbe4fefad34c18b914dbcf811.svg#copy-to-clipboard"></use></svg></button>
<a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/the-university-of-western-australia/waus-perth-virt-data-pt-03-2021-u-c/-/raw/master/02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js"><svg class="s16" data-testid="doc-code-icon"><use xlink:href="/assets/icons-15cbe21ccc2237b075efb0b0d170fc8d6716882dbe4fefad34c18b914dbcf811.svg#doc-code"></use></svg></a>
<a download="02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/the-university-of-western-australia/waus-perth-virt-data-pt-03-2021-u-c/-/raw/master/02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js?inline=false"><svg class="s16" data-testid="download-icon"><use xlink:href="/assets/icons-15cbe21ccc2237b075efb0b0d170fc8d6716882dbe4fefad34c18b914dbcf811.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button gl-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/the-university-of-western-australia/waus-perth-virt-data-pt-03-2021-u-c/-/blob/master/02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js">Fork</a>
...
<div class="blob-viewer" data-path="02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js" data-type="simple" data-url="/the-university-of-western-australia/waus-perth-virt-data-pt-03-2021-u-c/-/blob/master/02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js?format=json&amp;viewer=simple">
...
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/the-university-of-western-australia/waus-perth-virt-data-pt-03-2021-u-c/-/blob/master/02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="HRHRpRFUSHptljmdvk65aGkZP/WGH1iqfRrxDCUnDjGKMTBhJbC2ATdlTVGTnIuiUJV4+MAHIIV4Y/cvaT6lGg==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-93bd3bd28aa833a08b03331de201c75a">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-93bd3bd28aa833a08b03331de201c75a" class="form-control js-commit-message" placeholder="Delete data.js" required="required" rows="3">
...
<div class="col-sm-10">
<input type="text" name="branch_name" id="branch_name" value="DC-master-patch-88927" required="required" class="form-control js-branch-name ref-name" />
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-46f009197709371afb1d7efe7c46018e" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-46f009197709371afb1d7efe7c46018e">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/the-university-of-western-australia/waus-perth-virt-data-pt-03-2021-u-c/-/update/master/02-Homework/14-Intro-To-JavaScript/Instructions/StarterCode/static/js/data.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="chlXubhgec/MkwFKjRTaRxEL+pAmoo2u5FYyoV1QFpblObZ9jISHtJZgdYagxuiNKIe9nWC69YHhLzSCEUm9vQ==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-5b2b4f3c5b3f51349b315e6427b54e3b">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-5b2b4f3c5b3f51349b315e6427b54e3b" class="form-control js-commit-message" placeholder="Replace data.js" required="required" rows="3">
...
<label class="col-form-label col-sm-2" for="branch_name">Target Branch</label>
<div class="col-sm-10">
<input type="text" name="branch_name" id="branch_name" value="DC-master-patch-88929" required="required" class="form-control js-branch-name ref-name" />
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-14da1e58634c5fc64b1def6f4ed80f7e" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-14da1e58634c5fc64b1def6f4ed80f7e">Start a <strong>new merge request</strong> with these changes
</label></div>
